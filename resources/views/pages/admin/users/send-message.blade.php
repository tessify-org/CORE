...
@section("content")
    <div class="content-section__wrapper">
        <div class="content-section">
            ...
            <h1 class="page-title centered">@lang("tessify-core::admin.users_send_message_title")</h1>
                    ...
                    <div class="content-card__footer">
                        <div class="content-card__footer-left">
                            <v-btn text depressed href="{{ route('admin.users.view', $user->id) }}">
                                ...
                                @lang("tessify-core::admin.users_send_message_back")
                            </v-btn>
                        </div>
                        <div class="content-card__footer-right">
                            <v-btn dark depressed color="green" type="submit">
                                <i class="fas fa-paper-plane"></i>
                                @lang("tessify-core::admin.users_send_message_submit")
                            </v-btn>
                        </div>
                    </div>
